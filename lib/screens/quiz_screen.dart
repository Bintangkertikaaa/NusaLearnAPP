...
class _QuizScreenState extends State<QuizScreen> {
  ...
  Map<String, dynamic> _prepareQuestionWithShuffledAnswers(Map<String, dynamic> originalQuestion) {
    var correctAnswer = originalQuestion['options'][originalQuestion['correctIndex']];
  ...
  void initState() {
    ...
    if (widget.material.id == 'tari_1') { // Tari Saman
      originalQuestions = [
        {
        ...
        {
          'question': 'Siapakah tokoh yang menggunakan Tari Saman sebagai media dakwah?',
          'options': ['Syekh Saman', 'Sultan Iskandar Muda', 'Cut Nyak Dien', 'Teuku Umar'],
          'correctIndex': 0,
        },
        {
        ...
        {
          'question': 'Apa makna dari gerakan tangan menyilang di dada pada Tari Saman?',
          'options': [
            'Persaudaraan',
            'Keberanian',
            'Kesedihan',
    ...
    } else if (widget.material.id == 'tari_2') { // Tari Pendet
      originalQuestions = [
        {
    ...
    } else if (widget.material.id == 'musik_1') { // Gamelan
      originalQuestions = [
        {
    ...
    } else if (widget.material.id == 'musik_2') { // Angklung
      originalQuestions = [
        {
    ...
    } else if (widget.material.id == 'budaya_1') { // Upacara Adat
      originalQuestions = [
        {
          'question': 'Di mana upacara Kasada dilaksanakan?',
          'options': ['Gunung Bromo', 'Gunung Merapi', 'Gunung Semeru', 'Gunung Rinjani'],
          'correctIndex': 0,
        },
        {
    ...
    } else if (widget.material.id == 'budaya_2') { // Rumah Adat
      originalQuestions = [
        {
    ...
    List<Map<String, dynamic>> shuffledQuestions = List<Map<String, dynamic>>.from(_shuffleArray(originalQuestions));
  ...
  void _checkAnswer(int selectedIndex) {
    ...
    Future.delayed(const Duration(seconds: 2), () {
      if (_currentQuestionIndex < _questions.length - 1) {
        ...
        // Panggil callback onQuizCompleted jika skor mencapai minimum
        if (_score >= 3) { // Minimum 60% benar
